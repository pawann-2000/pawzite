...
- Rebase to the signed image, like so: 
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/pawann-2000/pawzite:latest
  ```
...
```bash
cosign verify --key cosign.pub ghcr.io/pawann-2000/pawzite
```

#### Expected output

![Successful signature verification](assets/image.png)
